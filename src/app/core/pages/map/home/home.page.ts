...
import { control, Control, Icon, layerGroup, LayerGroup, map, Map, Marker, tileLayer } from 'leaflet';
...
export class HomePage implements OnInit, AfterViewInit, OnDestroy {
  ...
  leafletMap() {
    ...
    const EsriSat = tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', { attribution: 'moi@2021' });
    ...
    this.layerController = control.layers(baseMaps, {}, {position: 'bottomleft'}).addTo(this.map);
  }
}
