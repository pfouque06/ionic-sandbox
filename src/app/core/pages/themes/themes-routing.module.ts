...
const routes: Routes = [
  { path: '', component: ThemesPage,children: [
    ...
    { path: 'qrcode-menu/:tab', loadChildren: () => import('./goodies/qrcode-menu/qrcode-menu.module').then( m => m.QRCodeMenuPageModule) },
    { path: 'barcode-menu', loadChildren: () => import('./goodies/bar-code-menu/bar-code-menu.module').then( m => m.BarCodeMenuPageModule) },
    { path: 'barcode-menu/:tab', loadChildren: () => import('./goodies/bar-code-menu/bar-code-menu.module').then( m => m.BarCodeMenuPageModule) },
